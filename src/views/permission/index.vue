  ...
  <div class="dashboard-container">
    <div class="app-container">
      <PageTools :isShowLeft="false">
        <template slot="right">
          <el-button type="" @click="showAddDialog('0', 1)">添加权限</el-button>
        </template>
      </PageTools>
      <el-table :data="permission" style="width: 100%" row-key="id" ref="table">
...
export default {
  ...
  methods: {
    async getPermissionList() {
      ...
      const treeList = transListtoTree(res, '0')
      this.permission = treeList
