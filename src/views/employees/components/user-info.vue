...
import { getUserDetails, getPersonalDetail } from '@/api/user'
import { saveUserDetailById, updatePersonal } from '@/api/employees'
...
export default {
  ...
  methods: {
    async getUserDetails() {
      const res = await getUserDetails(this.userId)
